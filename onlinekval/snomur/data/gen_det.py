...
def t3():
	blocks = [W]*500 + [rnd.randint(1, 30) for _ in range(3000)] + [rnd.randint(31, W) for _ in range(1500)]
	return blocks

def t4():
	blocks = [rnd.randint(150, 250) for _ in range(400)] + [rnd.randint(4, 6) for _ in range(600)]
	return blocks
